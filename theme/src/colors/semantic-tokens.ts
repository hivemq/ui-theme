export const semanticTokens = {
  ...
  primary: {
    bg: {
      value: { base: '{colors.action.primary.default}', _dark: '{colors.action.primary.default}' },
    },
    bg_hover: {
      value: { base: '{colors.action.primary.hover}', _dark: '{colors.action.primary.hover}' },
    },
    fg: { value: { base: '{colors.action.primary.fg}', _dark: '{colors.action.primary.fg}' } },
    border: {
      value: { base: '{colors.action.primary.border}', _dark: '{colors.action.primary.border}' },
    },
  },
  secondary: {
    bg: {
      value: {
        base: '{colors.action.secondary.default}',
        _dark: '{colors.action.secondary.default}',
      },
    },
    bg_hover: {
      value: { base: '{colors.action.secondary.hover}', _dark: '{colors.action.secondary.hover}' },
    },
    border: {
      value: {
        base: '{colors.action.secondary.border}',
        _dark: '{colors.action.secondary.border}',
      },
    },
  ...
  success: {
    bg: {
      value: { base: '{colors.action.success.default}', _dark: '{colors.action.success.default}' },
    },
    bg_hover: {
      value: { base: '{colors.action.success.hover}', _dark: '{colors.action.success.hover}' },
    },
    border: {
      value: { base: '{colors.action.success.border}', _dark: '{colors.action.success.border}' },
    },
  ...
  info: {
    ...
    bg_hover: {
      value: { base: '{colors.action.info.hover}', _dark: '{colors.action.info.hover}' },
    },
    text: { value: { base: '{colors.content.info}', _dark: '{colors.content.info}' } },
    border: {
      value: { base: '{colors.action.info.border}', _dark: '{colors.action.info.border}' },
    },
  },
  warning: {
    bg: {
      value: { base: '{colors.action.warning.default}', _dark: '{colors.action.warning.default}' },
    },
    bg_hover: {
      value: { base: '{colors.action.warning.hover}', _dark: '{colors.action.warning.hover}' },
    },
    border: {
      value: { base: '{colors.action.warning.border}', _dark: '{colors.action.warning.border}' },
    },
    fg: { value: { base: '{colors.action.warning.fg}', _dark: '{colors.action.warning.fg}' } },
  },
  error: {
    bg: {
      value: { base: '{colors.action.error.default}', _dark: '{colors.action.error.default}' },
    },
    bg_hover: {
      value: { base: '{colors.action.error.hover}', _dark: '{colors.action.error.hover}' },
    },
    border: {
      value: { base: '{colors.action.error.border}', _dark: '{colors.action.error.border}' },
    },
  ...
  highlight: {
    bg: {
      value: {
        base: '{colors.action.highlight.default}',
        _dark: '{colors.action.highlight.default}',
      },
    },
    bg_hover: {
      value: { base: '{colors.action.highlight.hover}', _dark: '{colors.action.highlight.hover}' },
    },
    border: {
      value: {
        base: '{colors.action.highlight.border}',
        _dark: '{colors.action.highlight.border}',
      },
    },
